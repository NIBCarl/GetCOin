...
export function Community() {
  const socialLinks = [
    ...
    {
      name: "Discord",
      url: "https://discord.gg/gencoinofficial",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: "Reddit",
      url: "https://www.reddit.com/r/gencoin_official",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-300 mb-6">
                Do you have relevant experience in finance, crypto, community management, or charitable initiatives? Apply to become a part of the GEN Council team and help shape the future of our project.
              </p>
              ...
              <div className="inline-block">
                <AnimatedButton 
                  ...
                  onClick={() => window.open("https://thegencouncil.com/", "_blank")}
                >
                  Apply Now
                </AnimatedButton>
              </div>
